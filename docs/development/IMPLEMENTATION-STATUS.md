...
- Accepts an optional local remote-state manifest path in the Publish pane and passes it through preview, validation, planned-history, saved-preview, and target-overview CLI calls
