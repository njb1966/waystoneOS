...
- Open the content index, edit Gemtext, save, and validate.
- Confirm local preview and link validation update from the saved text.
- Confirm the content-file list shows project-local files.
