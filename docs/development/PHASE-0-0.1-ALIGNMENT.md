...
is recorded, and the first project-owner visible issue in the Create pane has
been fixed.

Recommended next deliverables:

- Rerun the manual preview checklist in a visible desktop session and confirm
  the Create pane layout fix before installed-session work.
