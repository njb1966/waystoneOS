...
next slice should deliberately choose between richer feed diagnostics or another
narrow audio metadata repair action. It should still avoid real recording
