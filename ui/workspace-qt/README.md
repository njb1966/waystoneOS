...
- local Publish-pane target selection, ready/blocked preview status, planned history file-action summary, raw planned history preview, project-local planned preview save, saved-preview listing, selected saved-preview detail loading, saved-preview selection preservation, and generated-vs-saved comparison reporting
